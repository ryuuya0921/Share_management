...
### **ポテパンキャンプ**
- **初心者向けの基礎学習からお世話になりました。**
- **Heroku を用いたデプロイ方法を学習**
- **開発コードのレビュー & 修正を実践**
- **現場で使われている `Ruby on Rails` の開発手法を習得**

### 📖 **RubyonRails5 速習実践ガイド**
- **RSpec, Capybara, FactoryBot を用いたテストコードについて学習**
- **自動テストの重要性と実践的なテスト方法を習得**

### 🌍 **Qiita & Web 記事**
- **様々な Qiita 記事や技術ブログを参考に学習**
- **最新の `Rails` 開発手法やベストプラクティスを習得**
...
| **🌍 Qiita & Web 記事** | - 様々な `Qiita` 記事や技術ブログを参考に学習<br>- 最新の `Rails` 開発手法やベストプラクティスを習得 |
